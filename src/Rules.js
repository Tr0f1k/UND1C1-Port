    ...
    >
      ...
      <>
          ...
          <p>All actions are affected by dice roll results and player skills. In the future, when I am refering to skills, they can be of two 
            ...
            <img src={Paw} className='skills'></img> gives +1 to saves, and "Black Paw" <img src={BlackPaw} className='skills'></img> gives +2
          </p>
          <h3>Movement: </h3>
          <p>Click on any player. White squares are the ones to which your player is allowed to move. Players with the ball can move by 1 square
            any direction, and players without the ball - by 2 squares. If a player has a "Rabbit" skill <img src={Rabbit} className='skills'></img>, he gets +1 to movement (thus, 
            2 squares with the ball and 3 squares without the ball). If a player has a "Tractor" skill <img src={Tractor} className='skills'></img>, he can make a movement after
          ...
          <p>If the players of one team are located on the same line (by line I mean those red, yellow, green, and white stripes on the sides of the 
            ...
            <ol>
              <li>Distance to your opponent (I am still working to replicate the original formula, but it is a bit challenging. For now, 
                ...
                <li>Playmaker skill <img src={Playmaker} className='skills'></img>/<img src={BlackPlaymaker} className='skills'></img></li>
        ...
        <p>Tackling and dribbling work similar to each other. If you are in front or to the side of your opponent who has the ball, you can try
          ...
          <img src={Wizard} className='skills'></img>/<img src={BlackWizard} className='skills'></img> for a player with the 
          ball and "Gladiator" <img src={Gladiator} className='skills'></img>/<img src={BlackGladiator} className='skills'></img> 
        ...
        <p>A player can shoot the ball only from the squares with the numbers. When your player with the ball is located at one of those squares, 
          ...
          <ol>
            ...
            <li>Skills (If shooting from the penalty box - Viper <img src={Viper} className='skills'></img>/<img src={BlackViper} className='skills'></img>, 
            if shooting from outside the box - Cannon <img src={Cannon} className='skills'></img>/<img src={BlackCannon} className='skills'></img>. 
              For goalkeeper - Paw  <img src={Paw} className='skills'></img>/<img src={BlackPaw} className='skills'></img>)</li>
